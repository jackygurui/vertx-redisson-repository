 ...
 * @author Rui Gu
 */
public interface RedisRelativeTimeExpiryResolver<T> extends RedisExpiryResolver<T> {

    public long resolve(T value, JsonObject root, String id, String fieldName, RedissonCounter counter);
}
