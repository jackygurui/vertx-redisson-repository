 ...
 * @author Rui Gu
 */
public class EndOfDayExpiryResolver implements RedisRelativeTimeExpiryResolver<Object> {

    @Override
    public long resolve(Object value, JsonObject root, String id, String fieldName, RedissonCounter counter) {
        return LocalTime.of(23, 59, 59, 999999999).atDate(LocalDate.now()).atZone(ZoneId.systemDefault()).toEpochSecond() * 1000 + 999;
    }
}
