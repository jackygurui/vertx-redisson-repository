 ...
 * @author Rui Gu
 */
public class EndOfYearExpiryResolver implements RedisRelativeTimeExpiryResolver<Object> {

    @Override
    public long resolve(Object value, JsonObject root, String id, String fieldName, RedissonCounter counter) {
        return LocalTime.of(23, 59, 59, 999999999).atDate(LocalDate.now().withDayOfYear(LocalDate.now().lengthOfYear())).atZone(ZoneId.systemDefault()).toEpochSecond() * 1000 + 999;
    }
