 ...
 * @author Rui Gu
 */
public class LexicalScoreResolver<T> implements RedisIndexScoreResolver<T> {

    @Override
    public Double resolve(T value, JsonObject root, String id, String fieldName, RedissonIndex index) {
        return 0.0;
    }
