...
public class SaveAndSearchAndGetCallInTest {
    ...
    public void test2SaveAndSearchAndGetCallIn(TestContext context) throws Exception {
        ...
        Long number = Long.parseLong(clone.getString("phoneNumber")) + 2;
        ...
        org.simondean.vertx.async.Async.waterfall()
                .<String>task(t -> {
                    ...
                    ar.set(id);
                    callInRepository.searchIndexByScoreAndGet("callTime", 0d, clone.getDouble("callTime"), 0, 1, t);
                }).run(r -> {
